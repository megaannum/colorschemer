...
if has("gui_running")
  ...
  hi Search guifg=#000000 guibg=#fbf285
...
elseif &t_Co == 256
  ...
  hi StatusLine cterm=NONE ctermfg=15 ctermbg=248
  hi StatusLineNC cterm=NONE ctermfg=15 ctermbg=248
  ...
  hi VertSplit cterm=NONE ctermfg=248 ctermbg=248
...
elseif &t_Co == 88
  ...
  hi StatusLine cterm=NONE ctermfg=79 ctermbg=84
  hi StatusLineNC cterm=NONE ctermfg=79 ctermbg=84
