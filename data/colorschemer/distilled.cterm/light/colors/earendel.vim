...
if has("gui_running")
  ...
  hi ColorColumn guifg=#000000 guibg=#d5d5d5
  hi Comment guifg=#558817 guibg=bg
  hi Constant guifg=#a8660d guibg=bg
  hi Cursor guifg=#ffffff guibg=#000000
  hi CursorColumn guifg=#000000 guibg=#e0e0e0
  hi CursorLine guifg=#000000 guibg=#e0e0e0
  ...
  hi VisualNOS gui=bold,underline guifg=#324263 guibg=bg
...
elseif &t_Co == 88
  ...
  hi ColorColumn ctermfg=16 ctermbg=87
  hi Comment ctermbg=bg
  hi Constant ctermbg=bg
...
elseif &t_Co == 16
  hi Normal ctermfg=0 ctermbg=15
  hi ColorColumn ctermfg=0 ctermbg=11
  hi Comment ctermbg=bg
  hi Constant ctermbg=bg
