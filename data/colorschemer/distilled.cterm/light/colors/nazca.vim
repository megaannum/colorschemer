...
elseif &t_Co == 256
  ...
  hi Search cterm=underline ctermfg=0 ctermbg=229
...
elseif &t_Co == 88
  ...
  hi Search cterm=underline ctermfg=16 ctermbg=78
...
elseif &t_Co == 16
  ...
  hi Search cterm=underline ctermfg=0 ctermbg=11
  ...
  hi Search cterm=underline ctermfg=0 ctermbg=7
  hi SignColumn ctermbg=7
