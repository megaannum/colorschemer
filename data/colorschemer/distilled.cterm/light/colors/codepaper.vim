...
if has("gui_running")
  ...
  hi Cursor guifg=bg guibg=#111111
...
elseif &t_Co == 256
  ...
  hi Cursor ctermfg=bg ctermbg=233
  ...
  hi LineNr ctermfg=3 ctermbg=180
  ...
  hi SpellBad ctermfg=124 ctermbg=9
  hi SpellCap ctermbg=12
  hi SpellRare ctermbg=13
  hi Statement ctermfg=3 ctermbg=222
...
elseif &t_Co == 88
  ...
  hi Cursor ctermfg=bg ctermbg=16
  ...
  hi LineNr ctermfg=56 ctermbg=57
  hi MatchParen ctermfg=16
...
elseif &t_Co == 16
  ...
  hi Cursor ctermfg=bg ctermbg=0
  ...
  hi SpellCap ctermbg=12
  hi SpellRare ctermbg=13
  hi Statement ctermfg=3 ctermbg=11
