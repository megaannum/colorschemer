...
if has("gui_running")
  ...
  hi Boolean guifg=#003399 guibg=bg
  ...
  hi Constant guifg=#003399 guibg=bg
  ...
  hi Float guifg=#003399 guibg=bg
  hi Function guifg=#0055aa guibg=bg
  ...
  hi Number guifg=#003399 guibg=bg
  hi Operator guifg=#aa7733 guibg=bg
  hi PreProc guifg=#aa7733 guibg=bg
  ...
  hi StatusLine gui=NONE guifg=#000000 guibg=#f2f3bf
  hi StatusLineNC gui=NONE guifg=#000000 guibg=#ededed
  hi String guifg=#003399 guibg=bg
