...
if has("gui_running")
  ...
  hi Comment gui=italic guifg=#556b2f guibg=#ffffff
  hi Conditional gui=italic guifg=#003399 guibg=bg
  hi Constant guifg=#008000 guibg=bg
  hi Cursor guifg=#ffffff guibg=#0000cd
  hi CursorColumn guifg=#005faf
  hi CursorLine guifg=#005faf
  ...
  hi TabLineFill guifg=#0000cd guibg=bg
  hi TabLineSel guifg=#0000cd guibg=bg
  ...
  hi VimCommentTitle gui=italic guifg=#778899 guibg=#ffffff
  ...
  hi cursorim guifg=#00008b guibg=#ffffff
...
elseif &t_Co == 256
  ...
  hi CursorLine cterm=NONE ctermfg=25 ctermbg=252
  ...
  hi DiffText cterm=NONE ctermfg=57 ctermbg=231
  hi Error cterm=bold ctermfg=160 ctermbg=231
  hi ErrorMsg cterm=bold ctermfg=160 ctermbg=231
  hi Exception cterm=bold ctermfg=95 ctermbg=231
  hi Float ctermfg=29 ctermbg=bg
  hi FoldColumn cterm=bold ctermfg=37 ctermbg=231
  hi Folded cterm=bold ctermfg=38 ctermbg=231
  hi Function ctermfg=94 ctermbg=bg
  hi Identifier ctermfg=137 ctermbg=231
  hi Ignore ctermbg=bg
  hi IncSearch cterm=NONE ctermfg=19 ctermbg=231
  ...
  hi MoreMsg cterm=bold ctermfg=202 ctermbg=231
  ...
  hi PmenuThumb cterm=reverse ctermfg=110 ctermbg=231
  hi PreCondit ctermfg=134 ctermbg=bg
  hi PreProc ctermfg=54 ctermbg=231
  hi Question cterm=bold ctermfg=231 ctermbg=21
  hi Repeat ctermfg=21 ctermbg=bg
  hi Search ctermfg=17 ctermbg=231
  hi SignColumn cterm=bold ctermfg=19 ctermbg=231
  ...
  hi SpellCap cterm=underline ctermfg=52 ctermbg=231
  hi SpellLocal cterm=underline ctermfg=124 ctermbg=231
  hi SpellRare cterm=underline ctermfg=160 ctermbg=231
  hi Statement ctermfg=19 ctermbg=231
  hi StatusLine cterm=NONE ctermfg=64 ctermbg=231
  hi StatusLineNC cterm=NONE ctermfg=58 ctermbg=231
  ...
  hi TabLineSel cterm=underline ctermfg=20 ctermbg=231
...
elseif &t_Co == 88
  ...
  hi CursorLine cterm=NONE ctermfg=22 ctermbg=86
  ...
  hi DiffText cterm=NONE ctermfg=35 ctermbg=79
  hi Error cterm=bold ctermfg=48 ctermbg=79
  hi ErrorMsg cterm=bold ctermfg=48 ctermbg=79
  hi Exception cterm=bold ctermfg=81 ctermbg=79
  hi Float ctermfg=81 ctermbg=bg
  hi FoldColumn cterm=bold ctermfg=6 ctermbg=79
  hi Folded cterm=bold ctermfg=6 ctermbg=79
  hi Function ctermfg=32 ctermbg=bg
  hi Identifier ctermfg=53 ctermbg=79
  hi Ignore ctermbg=bg
  hi IncSearch cterm=NONE ctermfg=4 ctermbg=79
  ...
  hi MoreMsg cterm=bold ctermfg=68 ctermbg=79
  ...
  hi PmenuThumb cterm=reverse ctermfg=42 ctermbg=79
  hi PreCondit ctermfg=54 ctermbg=bg
  hi PreProc ctermfg=33 ctermbg=79
  hi Question cterm=bold ctermfg=79 ctermbg=19
  hi Repeat ctermfg=19 ctermbg=bg
  hi Search ctermfg=17 ctermbg=79
  hi SignColumn cterm=bold ctermfg=4 ctermbg=79
  ...
  hi SpellBad cterm=underline ctermfg=9 ctermbg=79
  hi SpellCap cterm=underline ctermfg=32 ctermbg=79
  hi SpellLocal cterm=underline ctermfg=48 ctermbg=79
  hi SpellRare cterm=underline ctermfg=48 ctermbg=79
  hi Statement ctermfg=4 ctermbg=79
  hi StatusLine cterm=NONE ctermfg=36 ctermbg=79
  hi StatusLineNC cterm=NONE ctermfg=36 ctermbg=79
  ...
  hi TabLineSel cterm=underline ctermfg=4 ctermbg=79
...
elseif &t_Co == 16
  ...
  hi CursorLine cterm=NONE ctermfg=6 ctermbg=7
  ...
  hi DiffText cterm=NONE ctermfg=5 ctermbg=15
  hi Error cterm=bold ctermfg=9 ctermbg=15
  hi ErrorMsg cterm=bold ctermfg=9 ctermbg=15
  hi Exception cterm=bold ctermfg=3 ctermbg=15
  hi Float ctermfg=6 ctermbg=bg
  hi FoldColumn cterm=bold ctermfg=6 ctermbg=15
  hi Folded cterm=bold ctermfg=6 ctermbg=15
  hi Function ctermfg=1 ctermbg=bg
  hi Identifier ctermfg=8 ctermbg=15
  hi Ignore ctermbg=bg
  hi IncSearch cterm=NONE ctermfg=4 ctermbg=15
  ...
  hi MoreMsg cterm=bold ctermfg=9 ctermbg=15
  ...
  hi PmenuThumb cterm=reverse ctermfg=8 ctermbg=15
  hi PreCondit ctermfg=7 ctermbg=bg
  hi PreProc ctermfg=5 ctermbg=15
  hi Question cterm=bold ctermfg=15 ctermbg=4
  hi Repeat ctermfg=4 ctermbg=bg
  hi Search ctermfg=4 ctermbg=15
  hi SignColumn cterm=bold ctermfg=4 ctermbg=15
  ...
  hi SpellBad cterm=underline ctermfg=9 ctermbg=15
  hi SpellCap cterm=underline ctermfg=1 ctermbg=15
  hi SpellLocal cterm=underline ctermfg=1 ctermbg=15
  hi SpellRare cterm=underline ctermfg=9 ctermbg=15
  hi Statement ctermfg=4 ctermbg=15
  hi StatusLine cterm=NONE ctermfg=3 ctermbg=15
  hi StatusLineNC cterm=NONE ctermfg=3 ctermbg=15
  ...
  hi TabLineSel cterm=underline ctermfg=4 ctermbg=15
  ...
  hi diffOldFile ctermfg=8 ctermbg=15
  hi diffRemoved ctermfg=1 ctermbg=bg
  hi qfLineNr ctermfg=6 ctermbg=12
else " 8 colors
  hi Normal ctermfg=4 ctermbg=7
  hi Boolean ctermfg=2 ctermbg=bg
  hi Character ctermfg=2 ctermbg=bg
  hi Comment cterm=italic ctermfg=3 ctermbg=7
  hi Conditional ctermfg=4 ctermbg=bg
  ...
  hi DiffText cterm=NONE ctermfg=5 ctermbg=7
  hi Error cterm=bold ctermfg=1 ctermbg=7
  hi ErrorMsg cterm=bold ctermfg=1 ctermbg=7
  hi Exception cterm=bold ctermfg=3 ctermbg=7
  hi Float ctermfg=6 ctermbg=bg
  hi FoldColumn cterm=bold ctermfg=6 ctermbg=7
  hi Folded cterm=bold ctermfg=6 ctermbg=7
  hi Function ctermfg=1 ctermbg=bg
  hi Identifier ctermfg=3 ctermbg=7
  hi Ignore ctermbg=bg
  hi IncSearch cterm=NONE ctermfg=4 ctermbg=7
  hi Include ctermfg=5 ctermbg=bg
  hi Keyword ctermfg=4 ctermbg=bg
  hi Label ctermfg=4 ctermbg=bg
  hi LineNr ctermfg=4 ctermbg=7
  ...
  hi MoreMsg cterm=bold ctermfg=3 ctermbg=7
  ...
  hi PmenuThumb cterm=reverse ctermfg=7 ctermbg=7
  hi PreCondit ctermfg=7 ctermbg=bg
  hi PreProc ctermfg=5 ctermbg=7
  hi Question cterm=bold ctermfg=7 ctermbg=4
  hi Repeat ctermfg=4 ctermbg=bg
  hi Search ctermfg=4 ctermbg=7
  hi SignColumn cterm=bold ctermfg=4 ctermbg=7
  ...
  hi SpellCap cterm=underline ctermfg=1 ctermbg=7
  hi SpellLocal cterm=underline ctermfg=1 ctermbg=7
  hi SpellRare cterm=underline ctermfg=1 ctermbg=7
  ...
  hi TabLineSel cterm=underline ctermfg=4 ctermbg=7
  hi Tag ctermfg=6 ctermbg=bg
  ...
  hi diffNewFile ctermfg=6 ctermbg=bg
  hi diffOldFile ctermfg=6 ctermbg=7
  hi diffRemoved ctermfg=1 ctermbg=bg
  hi qfLineNr ctermfg=6 ctermbg=7
endif
