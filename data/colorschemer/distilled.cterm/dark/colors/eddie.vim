...
elseif &t_Co == 256
  ...
  hi StatusLine cterm=reverse ctermfg=239 ctermbg=253
  hi StatusLineNC ctermfg=234 ctermbg=102
  hi String ctermfg=10
  hi Structure ctermfg=139
  hi TabLine ctermfg=253 ctermbg=16
  hi TabLineFill cterm=underline ctermfg=253 ctermbg=16
  hi TabLineSel cterm=NONE ctermfg=253 ctermbg=239
...
elseif &t_Co == 88
  ...
  hi StatusLine cterm=reverse ctermfg=81 ctermbg=86
...
elseif &t_Co == 16
  ...
  hi StatusLine cterm=reverse ctermfg=2 ctermbg=12
