...
elseif &t_Co == 256
  ...
  hi MatchParen ctermfg=37 ctermbg=14
  ...
  hi Visual ctermfg=238 ctermbg=7
...
elseif &t_Co == 88
  ...
  hi MatchParen ctermfg=25 ctermbg=31
  ...
  hi Visual ctermfg=81 ctermbg=87
...
elseif &t_Co == 16
  ...
  hi MatchParen ctermfg=6 ctermbg=14
  hi MoreMsg ctermfg=2
  ...
  hi Visual ctermfg=1 ctermbg=11
  ...
  hi LineNr ctermfg=3 ctermbg=2
  hi MatchParen ctermfg=6 ctermbg=6
  hi MoreMsg ctermfg=2
  hi NonText ctermbg=0
  hi PmenuSbar ctermbg=7
  hi PmenuSel ctermfg=0 ctermbg=7
