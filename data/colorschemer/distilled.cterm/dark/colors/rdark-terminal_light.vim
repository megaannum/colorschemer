...
if has("gui_running")
  ...
  hi DiffAdd guifg=#87d75f guibg=LightBlue
  hi DiffChange guifg=#d0d0d0 guibg=LightMagenta
  hi DiffDelete guibg=LightCyan
  hi DiffText guifg=#d0d0d0
  hi Directory guifg=Blue guibg=#000000
  ...
  hi Identifier guifg=DarkCyan guibg=#000000
  ...
  hi MatchParen guifg=#005f5f guibg=Cyan
  ...
  hi PreProc guifg=Purple guibg=#000000
  hi Question guifg=SeaGreen guibg=#000000
  hi Search guifg=NONE
  hi SignColumn guifg=DarkBlue
  hi Special guifg=SlateBlue guibg=#000000
  hi SpecialKey guifg=Blue guibg=#000000
