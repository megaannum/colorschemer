...
if has("gui_running")
  ...
  hi FoldColumn guifg=darkmagenta guibg=black
  hi Folded guifg=darkmagenta guibg=black
...
elseif &t_Co == 256
  ...
  hi LineNr cterm=underline ctermfg=0 ctermbg=225
  hi ModeMsg cterm=underline ctermfg=0 ctermbg=10
  hi MoreMsg cterm=underline ctermfg=0 ctermbg=5
  hi NonText cterm=underline ctermfg=5 ctermbg=0
  ...
  hi Title cterm=underline ctermfg=7 ctermbg=5
  hi Todo cterm=underline ctermbg=9
  hi Type ctermbg=0
  hi Underlined ctermbg=0
  hi VertSplit cterm=NONE ctermfg=5 ctermbg=5
...
elseif &t_Co == 88
  ...
  hi LineNr cterm=underline ctermfg=16 ctermbg=75
  hi ModeMsg cterm=underline ctermfg=16 ctermbg=28
  hi MoreMsg cterm=underline ctermfg=16 ctermbg=50
  hi NonText cterm=underline ctermfg=50 ctermbg=16
  hi PreProc ctermfg=75 ctermbg=16
  hi Question cterm=underline ctermfg=16 ctermbg=50
  hi Search cterm=underline
  ...
  hi StatusLineNC ctermfg=16 ctermbg=50
  hi Title cterm=underline ctermfg=87 ctermbg=50
  hi Todo cterm=underline ctermbg=9
  hi Type ctermbg=16
  hi Underlined ctermbg=16
  hi VertSplit cterm=NONE ctermfg=50 ctermbg=50
...
elseif &t_Co == 16
  ...
  hi LineNr cterm=underline ctermfg=0 ctermbg=15
  hi ModeMsg cterm=underline ctermfg=0 ctermbg=2
  hi MoreMsg cterm=underline ctermfg=0 ctermbg=13
  hi NonText cterm=underline ctermfg=13 ctermbg=0
  hi PreProc ctermfg=15 ctermbg=0
  hi Question cterm=underline ctermfg=0 ctermbg=13
  hi Search cterm=underline
  hi Special ctermfg=14 ctermbg=0
  hi SpecialKey ctermfg=14 ctermbg=0
  hi Statement ctermfg=11 ctermbg=0
  hi StatusLine cterm=underline ctermfg=0 ctermbg=8
  hi StatusLineNC ctermfg=0 ctermbg=13
  hi Title cterm=underline ctermfg=11 ctermbg=13
  hi Todo cterm=underline ctermbg=9
  hi Type ctermbg=0
  hi Underlined ctermbg=0
  hi VertSplit cterm=NONE ctermfg=13 ctermbg=13
