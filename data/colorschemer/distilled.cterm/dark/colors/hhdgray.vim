...
if has("gui_running")
  ...
  hi FoldColumn guifg=darkgray guibg=black
...
elseif &t_Co == 256
  ...
  hi MoreMsg cterm=underline ctermfg=0 ctermbg=242
  hi NonText cterm=underline ctermfg=242 ctermbg=0
  hi PreProc ctermfg=225 ctermbg=0
  hi Question cterm=underline ctermfg=0 ctermbg=242
  ...
  hi StatusLineNC cterm=underline ctermfg=0 ctermbg=242
  hi Title cterm=underline ctermfg=7 ctermbg=242
...
elseif &t_Co == 88
  ...
  hi LineNr cterm=underline ctermfg=16 ctermbg=87
  hi ModeMsg cterm=underline ctermfg=16 ctermbg=28
  hi MoreMsg cterm=underline ctermfg=16 ctermbg=82
  hi NonText cterm=underline ctermfg=82 ctermbg=16
  hi PreProc ctermfg=75 ctermbg=16
  hi Question cterm=underline ctermfg=16 ctermbg=82
  hi Search cterm=underline
  ...
  hi StatusLineNC cterm=underline ctermfg=16 ctermbg=82
  hi Title cterm=underline ctermfg=87 ctermbg=82
  hi Todo cterm=underline ctermbg=9
  hi Type ctermbg=16
...
elseif &t_Co == 16
  ...
  hi StatusLineNC cterm=underline ctermfg=0 ctermbg=3
