...
elseif &t_Co == 256
  ...
  hi Constant ctermfg=1 ctermbg=15
  ...
  hi PreProc cterm=bold ctermfg=5 ctermbg=15
...
elseif &t_Co == 88
  ...
  hi PreProc cterm=bold ctermfg=50 ctermbg=79
...
elseif &t_Co == 16
  ...
  hi PmenuSel ctermfg=15
  hi PmenuThumb ctermbg=0
  hi PreProc cterm=bold ctermfg=13 ctermbg=15
  hi Question ctermfg=0 ctermbg=15
  hi Search ctermbg=9
  hi SignColumn ctermfg=0 ctermbg=15
  ...
  hi PmenuThumb ctermbg=0
  hi PreProc cterm=bold ctermfg=5 ctermbg=7
