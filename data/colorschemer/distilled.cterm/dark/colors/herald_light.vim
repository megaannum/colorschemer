...
if has("gui_running")
  ...
  hi Comment guifg=Blue guibg=#1c1c1c
  hi Constant guifg=Magenta guibg=#1c1c1c
...
elseif &t_Co == 256
  ...
  hi Identifier cterm=NONE ctermfg=75 ctermbg=234
...
elseif &t_Co == 88
  ...
  hi Identifier cterm=NONE ctermfg=43 ctermbg=80
...
elseif &t_Co == 16
  ...
  hi Identifier cterm=NONE ctermfg=12 ctermbg=0
