...
if has("gui_running")
  ...
  hi Cursor guifg=#ffffff guibg=#afd7d7
...
elseif &t_Co == 256
  ...
  hi Visual cterm=reverse ctermfg=72 ctermbg=15
  hi VisualNOS cterm=bold,underline ctermfg=151 ctermbg=0
...
elseif &t_Co == 88
  ...
  hi Visual cterm=reverse ctermfg=41 ctermbg=79
  hi VisualNOS cterm=bold,underline ctermfg=85 ctermbg=16
...
elseif &t_Co == 16
  ...
  hi Visual cterm=reverse ctermfg=8 ctermbg=15
