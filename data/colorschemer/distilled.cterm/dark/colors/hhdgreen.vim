...
if has("gui_running")
  ...
  hi FoldColumn guifg=darkgreen guibg=black
  hi Folded guifg=darkgreen guibg=black
...
elseif &t_Co == 256
  ...
  hi LineNr cterm=underline ctermfg=0 ctermbg=121
...
elseif &t_Co == 88
  ...
  hi LineNr cterm=underline ctermfg=16 ctermbg=46
  hi ModeMsg cterm=underline ctermfg=16 ctermbg=28
  hi MoreMsg cterm=underline ctermfg=16 ctermbg=24
  hi NonText cterm=underline ctermfg=24 ctermbg=16
  hi PreProc ctermfg=75 ctermbg=16
  hi Question cterm=underline ctermfg=16 ctermbg=24
  hi Search cterm=underline
  ...
  hi StatusLineNC ctermfg=16 ctermbg=24
  hi Title cterm=underline ctermfg=87 ctermbg=24
  hi Todo cterm=underline ctermbg=9
  hi Type ctermbg=16
  hi Underlined ctermbg=16
  hi VertSplit cterm=NONE ctermfg=24 ctermbg=24
...
elseif &t_Co == 16
  ...
  hi LineNr cterm=underline ctermfg=0 ctermbg=10
