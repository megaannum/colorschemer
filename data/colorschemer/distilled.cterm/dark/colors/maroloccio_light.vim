...
if has("gui_running")
  ...
  hi PmenuThumb guifg=#000000 guibg=Black
  ...
  hi SpellBad guifg=#ff0000 guibg=#ffd7d7
  hi SpellCap guifg=#0000ff guibg=#5fd7ff
  hi SpellLocal guifg=#00ffff
  hi SpellRare guifg=#ff00ff guibg=#ffd7ff
...
elseif &t_Co == 256
  ...
  hi SpellBad cterm=undercurl ctermfg=196 ctermbg=224
  hi SpellCap cterm=undercurl ctermfg=21 ctermbg=81
  hi SpellLocal cterm=undercurl ctermfg=51
  hi SpellRare cterm=undercurl ctermfg=201 ctermbg=225
...
elseif &t_Co == 88
  ...
  hi Identifier cterm=NONE ctermfg=47
  hi Ignore ctermfg=16
  ...
  hi SpellBad cterm=undercurl ctermfg=9 ctermbg=74
  hi SpellCap cterm=undercurl ctermfg=19 ctermbg=43
  hi SpellLocal cterm=undercurl ctermfg=31
  hi SpellRare cterm=undercurl ctermfg=67 ctermbg=75
...
elseif &t_Co == 16
  ...
  hi SpellCap cterm=undercurl ctermfg=4 ctermbg=12
  hi SpellLocal cterm=undercurl ctermfg=14
  hi SpellRare cterm=undercurl ctermfg=13 ctermbg=15
  ...
  hi SpellCap cterm=undercurl ctermfg=4 ctermbg=7
  hi SpellLocal cterm=undercurl ctermfg=6
  hi SpellRare cterm=undercurl ctermfg=5 ctermbg=7
