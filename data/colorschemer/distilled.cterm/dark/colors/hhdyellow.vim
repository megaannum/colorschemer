...
if has("gui_running")
  ...
  hi FoldColumn guifg=darkyellow guibg=black
  hi Folded guifg=darkyellow guibg=black
...
elseif &t_Co == 256
  ...
  hi FoldColumn ctermfg=130 ctermbg=0
  hi Folded ctermfg=130 ctermbg=0
  hi Identifier cterm=NONE ctermbg=0
  hi Ignore ctermbg=0
  hi IncSearch cterm=underline ctermfg=0 ctermbg=10
  hi LineNr cterm=underline ctermfg=0 ctermbg=229
  hi ModeMsg cterm=underline ctermfg=0 ctermbg=10
  hi MoreMsg cterm=underline ctermfg=0 ctermbg=130
  hi NonText cterm=underline ctermfg=130 ctermbg=0
  hi PreProc ctermfg=225 ctermbg=0
  hi Question cterm=underline ctermfg=0 ctermbg=130
  ...
  hi StatusLineNC ctermfg=0 ctermbg=130
  hi Title cterm=underline ctermfg=7 ctermbg=130
  hi Todo cterm=underline ctermbg=9
  hi Type ctermbg=0
  hi Underlined ctermbg=0
  hi VertSplit cterm=NONE ctermfg=130 ctermbg=130
...
elseif &t_Co == 88
  ...
  hi FoldColumn ctermfg=52 ctermbg=16
  hi Folded ctermfg=52 ctermbg=16
  hi Identifier cterm=NONE ctermbg=16
  hi Ignore ctermbg=16
  hi IncSearch cterm=underline ctermfg=16 ctermbg=28
  hi LineNr cterm=underline ctermfg=16 ctermbg=78
  hi ModeMsg cterm=underline ctermfg=16 ctermbg=28
  hi MoreMsg cterm=underline ctermfg=16 ctermbg=52
  hi NonText cterm=underline ctermfg=52 ctermbg=16
  hi PreProc ctermfg=75 ctermbg=16
  hi Question cterm=underline ctermfg=16 ctermbg=52
  hi Search cterm=underline
  ...
  hi Title cterm=underline ctermfg=87 ctermbg=52
  hi Todo cterm=underline ctermbg=9
  hi Type ctermbg=16
  hi Underlined ctermbg=16
  hi VertSplit cterm=NONE ctermfg=52 ctermbg=52
...
elseif &t_Co == 16
  ...
  hi LineNr cterm=underline ctermfg=0 ctermbg=11
  hi ModeMsg cterm=underline ctermfg=0 ctermbg=2
  hi MoreMsg cterm=underline ctermfg=0 ctermbg=3
  hi NonText cterm=underline ctermfg=3 ctermbg=0
  hi PreProc ctermfg=15 ctermbg=0
  hi Question cterm=underline ctermfg=0 ctermbg=3
  hi Search cterm=underline
  ...
  hi Title cterm=underline ctermfg=11 ctermbg=3
  hi Todo cterm=underline ctermbg=9
  hi Type ctermbg=0
  hi Underlined ctermbg=0
  ...
  hi StatusLineNC ctermfg=0 ctermbg=3
  hi Title cterm=underline ctermfg=7 ctermbg=3
