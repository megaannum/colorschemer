...
elseif &t_Co == 256
  ...
  hi Identifier cterm=NONE ctermfg=15 ctermbg=4
...
elseif &t_Co == 88
  ...
  hi Identifier cterm=NONE ctermfg=79 ctermbg=19
...
elseif &t_Co == 16
  ...
  hi FoldColumn ctermbg=0
  hi Folded ctermfg=6 ctermbg=4
  hi Identifier cterm=NONE ctermfg=7 ctermbg=4
  hi LineNr ctermfg=7 ctermbg=0
  hi ModeMsg cterm=NONE ctermfg=7 ctermbg=0
  hi MoreMsg ctermfg=7 ctermbg=0
