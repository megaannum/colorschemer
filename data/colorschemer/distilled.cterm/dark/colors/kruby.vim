...
if has("gui_running")
  hi Normal guifg=#d1c1cf guibg=#070706
  hi Comment guifg=#76d676
...
elseif &t_Co == 88
  ...
  hi rubyClassVariable ctermfg=16
  hi rubyConditional ctermfg=48
  hi rubyConditionalModifier ctermfg=82
  hi rubyConstant ctermfg=53
  hi rubyControl ctermfg=40
  hi rubyDefine ctermfg=84
