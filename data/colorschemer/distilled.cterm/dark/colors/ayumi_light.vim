...
if has("gui_running")
  ...
  hi PmenuThumb guifg=#66d9ef guibg=Black
...
elseif &t_Co == 256
  ...
  hi PmenuSel ctermfg=0 ctermbg=244
  hi PmenuThumb ctermfg=81 ctermbg=0
  ...
  hi SpellCap cterm=underline ctermbg=81
  hi SpellLocal cterm=underline
  hi SpellRare cterm=underline ctermbg=225
  ...
  hi Visual ctermfg=231 ctermbg=237
...
elseif &t_Co == 88
  ...
  hi SpellCap cterm=underline ctermbg=43
  hi SpellLocal cterm=underline
  hi SpellRare cterm=underline ctermbg=75
  ...
  hi Visual ctermfg=79 ctermbg=80
...
elseif &t_Co == 16
  ...
  hi SpellLocal cterm=underline
  hi SpellRare cterm=underline ctermbg=15
  ...
  hi SpellLocal cterm=underline
  hi SpellRare cterm=underline ctermbg=7
