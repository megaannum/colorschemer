...
elseif &t_Co == 256
  ...
  hi LineNr cterm=underline ctermfg=0 ctermbg=224
  hi ModeMsg cterm=underline ctermfg=0 ctermbg=10
  hi MoreMsg cterm=underline ctermfg=0 ctermbg=1
  hi NonText cterm=underline ctermfg=1 ctermbg=0
  hi PreProc ctermfg=225 ctermbg=0
  hi Question cterm=underline ctermfg=0 ctermbg=1
  ...
  hi Title cterm=underline ctermfg=7 ctermbg=1
  hi Todo cterm=underline ctermbg=9
  hi Type ctermbg=0
  hi Underlined ctermbg=0
  hi VertSplit cterm=NONE ctermfg=1 ctermbg=1
...
elseif &t_Co == 88
  ...
  hi LineNr cterm=underline ctermfg=16 ctermbg=74
  hi ModeMsg cterm=underline ctermfg=16 ctermbg=28
  hi MoreMsg cterm=underline ctermfg=16 ctermbg=48
  hi NonText cterm=underline ctermfg=48 ctermbg=16
  hi PreProc ctermfg=75 ctermbg=16
  hi Question cterm=underline ctermfg=16 ctermbg=48
  hi Search cterm=underline
  ...
  hi StatusLineNC ctermfg=16 ctermbg=48
  hi Title cterm=underline ctermfg=87 ctermbg=48
  hi Todo cterm=underline ctermbg=9
  hi Type ctermbg=16
  hi Underlined ctermbg=16
  hi VertSplit cterm=NONE ctermfg=48 ctermbg=48
...
elseif &t_Co == 16
  ...
  hi MoreMsg cterm=underline ctermfg=0 ctermbg=9
  hi NonText cterm=underline ctermfg=9 ctermbg=0
  hi PreProc ctermfg=15 ctermbg=0
  hi Question cterm=underline ctermfg=0 ctermbg=9
  hi Search cterm=underline
  ...
  hi Title cterm=underline ctermfg=11 ctermbg=9
  hi Todo cterm=underline ctermbg=9
  hi Type ctermbg=0
  hi Underlined ctermbg=0
  hi VertSplit cterm=NONE ctermfg=9 ctermbg=9
