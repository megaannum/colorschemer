...
if has("gui_running")
  ...
  hi Function guifg=DarkGreen guibg=bg
  ...
  hi Statement gui=NONE guifg=DarkBlue guibg=bg
  ...
  hi Todo guifg=bg guibg=DarkCyan
  hi Type gui=NONE guifg=DarkMagenta guibg=bg
