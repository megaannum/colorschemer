...
if has("gui_running")
  hi Normal guifg=#f0c009 guibg=black
  hi Boolean guifg=#ff00aa
  hi Comment guifg=#8080af
  ...
  hi Statement gui=NONE guifg=#fff0ff
...
elseif &t_Co == 256
  hi Normal ctermfg=214 ctermbg=16
...
elseif &t_Co == 88
  hi Normal ctermfg=72 ctermbg=16
