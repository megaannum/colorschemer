" Vim color file
" Converted from Textmate theme Pastie2 using Coloration v0.2.5 (http://github.com/sickill/coloration)
...
let g:colors_name = "Pastie2"

hi Cursor  guifg=NONE guibg=#000000 gui=NONE
hi Visual  guifg=NONE guibg=#c2c971 gui=NONE
hi CursorLine  guifg=NONE guibg=#ded4a7 gui=NONE
hi CursorColumn  guifg=NONE guibg=#ded4a7 gui=NONE
hi LineNr  guifg=#7a755c guibg=#f4e9b8 gui=NONE
hi VertSplit  guifg=#c6bd95 guibg=#c6bd95 gui=NONE
hi MatchParen  guifg=#138b05 guibg=NONE gui=bold
hi StatusLine  guifg=#000000 guibg=#c6bd95 gui=bold
hi StatusLineNC  guifg=#000000 guibg=#c6bd95 gui=NONE
hi Pmenu  guifg=#b80066 guibg=NONE gui=NONE
hi PmenuSel  guifg=NONE guibg=#c2c971 gui=NONE
hi IncSearch  guifg=NONE guibg=#a8bdb9 gui=NONE
hi Search  guifg=NONE guibg=#a8bdb9 gui=NONE
hi Directory  guifg=#dc6036 guibg=NONE gui=bold
hi Folded  guifg=#888888 guibg=#f4e9b8 gui=NONE

hi Normal  guifg=#000000 guibg=#f4e9b8 gui=NONE
...
hi Label  guifg=#d71707 guibg=#e6dcae gui=NONE
hi NonText  guifg=#404040 guibg=#ded4a7 gui=NONE
...
hi rubyStringDelimiter  guifg=#d71707 guibg=#e6dcae gui=NONE
...
hi rubyRegexp  guifg=#d71707 guibg=#e6dcae gui=NONE
hi rubyRegexpDelimiter  guifg=#d71707 guibg=#e6dcae gui=NONE
...
hi yamlDocumentHeader  guifg=#d71707 guibg=#e6dcae gui=NONE
