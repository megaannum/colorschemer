...
elseif &t_Co == 256
  ...
  hi LineNr cterm=underline ctermfg=0 ctermbg=14
  hi ModeMsg cterm=underline ctermfg=0 ctermbg=10
  hi MoreMsg cterm=underline ctermfg=0 ctermbg=6
  hi NonText cterm=underline ctermfg=6 ctermbg=0
  hi PreProc ctermfg=13 ctermbg=0
  hi Question cterm=underline ctermfg=0 ctermbg=6
  ...
  hi Title cterm=underline ctermfg=7 ctermbg=6
  hi Todo cterm=underline ctermbg=12
  hi Type ctermbg=0
  hi Underlined ctermbg=0
  hi VertSplit cterm=NONE ctermfg=6 ctermbg=6
...
elseif &t_Co == 88
  ...
  hi LineNr cterm=underline ctermfg=16 ctermbg=31
  hi ModeMsg cterm=underline ctermfg=16 ctermbg=28
  hi MoreMsg cterm=underline ctermfg=16 ctermbg=6
  hi NonText cterm=underline ctermfg=6 ctermbg=16
  hi PreProc ctermfg=67 ctermbg=16
  hi Question cterm=underline ctermfg=16 ctermbg=6
  hi Search cterm=underline
  ...
  hi Title cterm=underline ctermfg=87 ctermbg=6
...
elseif &t_Co == 16
  ...
  hi StatusLineNC ctermfg=0 ctermbg=6
  hi Title cterm=underline ctermfg=11 ctermbg=6
  hi Todo cterm=underline ctermbg=12
  hi Type ctermbg=0
  hi Underlined ctermbg=0
  hi VertSplit cterm=NONE ctermfg=6 ctermbg=6
  ...
  hi Ignore ctermbg=0
  hi IncSearch cterm=underline ctermfg=0 ctermbg=2
  hi LineNr cterm=underline ctermfg=0 ctermbg=6
  hi ModeMsg cterm=underline ctermfg=0 ctermbg=2
  hi MoreMsg cterm=underline ctermfg=0 ctermbg=6
  hi NonText cterm=underline ctermfg=6 ctermbg=0
