...
elseif &t_Co == 256
  ...
  hi DiffChange ctermfg=9 ctermbg=1
...
elseif &t_Co == 88
  ...
  hi DiffChange ctermfg=9 ctermbg=48
  hi DiffDelete ctermfg=39 ctermbg=19
...
elseif &t_Co == 16
  ...
  hi DiffChange ctermfg=9 ctermbg=9
  hi DiffDelete ctermfg=12 ctermbg=4
  ...
  hi DiffAdd ctermfg=2 ctermbg=2
  hi DiffChange ctermfg=1 ctermbg=1
  hi DiffDelete ctermfg=5 ctermbg=4
