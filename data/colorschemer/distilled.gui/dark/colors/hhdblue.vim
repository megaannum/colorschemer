...
elseif &t_Co == 256
  ...
  hi LineNr cterm=underline ctermfg=0 ctermbg=9
...
elseif &t_Co == 88
  ...
  hi LineNr cterm=underline ctermfg=16 ctermbg=9
  hi ModeMsg cterm=underline ctermfg=16 ctermbg=28
  hi MoreMsg cterm=underline ctermfg=16 ctermbg=9
  hi NonText cterm=underline ctermfg=48 ctermbg=16
  hi PreProc ctermfg=67 ctermbg=16
  hi Question cterm=underline ctermfg=16 ctermbg=9
  hi Search cterm=underline
...
elseif &t_Co == 16
  ...
  hi Ignore ctermbg=0
  hi IncSearch cterm=underline ctermfg=0 ctermbg=2
  hi LineNr cterm=underline ctermfg=0 ctermbg=1
  hi ModeMsg cterm=underline ctermfg=0 ctermbg=2
