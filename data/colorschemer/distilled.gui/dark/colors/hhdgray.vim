...
elseif &t_Co == 256
  ...
  hi MoreMsg cterm=underline ctermfg=0 ctermbg=8
  hi NonText cterm=underline ctermfg=8 ctermbg=0
  hi PreProc ctermfg=13 ctermbg=0
  hi Question cterm=underline ctermfg=0 ctermbg=8
  ...
  hi StatusLineNC cterm=underline ctermfg=0 ctermbg=8
  hi Title cterm=underline ctermfg=7 ctermbg=8
...
elseif &t_Co == 88
  ...
  hi MoreMsg cterm=underline ctermfg=16 ctermbg=81
  hi NonText cterm=underline ctermfg=81 ctermbg=16
  hi PreProc ctermfg=67 ctermbg=16
  hi Question cterm=underline ctermfg=16 ctermbg=81
  hi Search cterm=underline
  ...
  hi StatusLineNC cterm=underline ctermfg=16 ctermbg=81
  hi Title cterm=underline ctermfg=87 ctermbg=81
...
elseif &t_Co == 16
  ...
  hi MoreMsg cterm=underline ctermfg=0 ctermbg=2
  hi NonText cterm=underline ctermfg=2 ctermbg=0
  hi PreProc ctermfg=13 ctermbg=0
  hi Question cterm=underline ctermfg=0 ctermbg=2
  hi Search cterm=underline
  hi Special ctermfg=11 ctermbg=0
  hi SpecialKey ctermfg=11 ctermbg=0
  hi Statement ctermbg=0
  hi StatusLine cterm=underline ctermfg=0 ctermbg=11
  hi StatusLineNC cterm=underline ctermfg=0 ctermbg=2
  hi Title cterm=underline ctermfg=11 ctermbg=2
  hi Todo cterm=underline ctermbg=12
  hi Type ctermbg=0
  hi Underlined ctermbg=0
  ...
  hi StatusLine cterm=underline ctermfg=0 ctermbg=7
  hi StatusLineNC cterm=underline ctermfg=0 ctermbg=2
  hi Title cterm=underline ctermfg=7 ctermbg=2
