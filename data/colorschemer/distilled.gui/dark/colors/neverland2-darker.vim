...
" Name: neverland2-darker
" ColorSchemerVersion: 1.0
" User: emberson
" Date: 2012-09-29 13:40:02
"----------------------------------------------------------
...
if has("gui_running")
  ...
  hi DiffText guibg=#080808
  hi Directory gui=bold guifg=#87ff00
  hi Error guifg=#ffafff guibg=#080808
  hi ErrorMsg gui=bold guifg=#ff00af guibg=#080808
...
elseif &t_Co == 256
  ...
  hi ErrorMsg cterm=bold ctermfg=199 ctermbg=232
