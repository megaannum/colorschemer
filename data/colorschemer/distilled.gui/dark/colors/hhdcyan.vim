...
if has("gui_running")
  ...
  hi FoldColumn guifg=darkcyan guibg=black
  hi Folded guifg=darkcyan guibg=black
...
elseif &t_Co == 88
  ...
  hi FoldColumn ctermfg=56 ctermbg=16
  ...
  hi LineNr cterm=underline ctermfg=16 ctermbg=76
  hi ModeMsg cterm=underline ctermfg=16 ctermbg=28
  hi MoreMsg cterm=underline ctermfg=16 ctermbg=56
  hi NonText cterm=underline ctermfg=56 ctermbg=16
  hi PreProc ctermfg=67 ctermbg=16
  hi Question cterm=underline ctermfg=16 ctermbg=56
  hi Search cterm=underline
  ...
  hi Title cterm=underline ctermfg=87 ctermbg=56
  hi Todo cterm=underline ctermbg=39
  hi Type ctermbg=16
  hi Underlined ctermbg=16
  hi VertSplit cterm=NONE ctermfg=56 ctermbg=56
...
elseif &t_Co == 16
  ...
  hi Ignore ctermbg=0
  hi IncSearch cterm=underline ctermfg=0 ctermbg=2
  hi LineNr cterm=underline ctermfg=0 ctermbg=3
  hi ModeMsg cterm=underline ctermfg=0 ctermbg=2
  hi MoreMsg cterm=underline ctermfg=0 ctermbg=3
  hi NonText cterm=underline ctermfg=3 ctermbg=0
