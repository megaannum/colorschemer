...
if has("gui_running")
  ...
  hi Comment guifg=Gray guibg=DarkBlue
  hi Constant guibg=DarkBlue
  ...
  hi Identifier guifg=White guibg=DarkBlue
  ...
  hi PreProc guifg=Green guibg=DarkBlue
  hi Question guifg=Green
  hi Search guifg=Black guibg=Gray
  hi SignColumn guifg=Cyan
  hi Special guifg=Cyan guibg=DarkBlue
...
elseif &t_Co == 256
  ...
  hi Constant ctermfg=13 ctermbg=1
  ...
  hi Special ctermfg=11 ctermbg=1
...
elseif &t_Co == 88
  ...
  hi Constant ctermfg=67 ctermbg=48
  ...
  hi Special ctermfg=76 ctermbg=48
  hi SpecialKey ctermfg=9
...
elseif &t_Co == 16
  ...
  hi Constant ctermfg=13 ctermbg=9
  hi Cursor ctermfg=0 ctermbg=14
  ...
  hi Special ctermfg=11 ctermbg=9
  hi SpecialKey ctermfg=9
  ...
  hi ColorColumn ctermbg=4
  hi Comment ctermfg=7 ctermbg=1
  hi Constant ctermfg=5 ctermbg=1
  ...
  hi Special ctermfg=3 ctermbg=1
