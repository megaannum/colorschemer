...
elseif &t_Co == 256
  ...
  hi Directory ctermfg=11 ctermbg=246
  ...
  hi LineNr ctermfg=14 ctermbg=249
  hi Macro ctermfg=95 ctermbg=249
  hi MatchParen ctermfg=16 ctermbg=3
  hi ModeMsg ctermfg=231 ctermbg=166
  hi MoreMsg ctermfg=10 ctermbg=208
  ...
  hi PreProc ctermfg=9 ctermbg=246
  hi Question ctermfg=10 ctermbg=246
  hi Repeat ctermfg=215
  hi SignColumn ctermfg=11 ctermbg=8
  hi Special ctermfg=12 ctermbg=246
  hi SpecialChar ctermfg=231 ctermbg=96
  hi SpecialComment ctermfg=219 ctermbg=246
  hi SpecialKey ctermfg=9 ctermbg=246
  ...
  hi WarningMsg ctermfg=12 ctermbg=202
...
elseif &t_Co == 88
  ...
  hi Directory ctermfg=76 ctermbg=83
  ...
  hi MoreMsg ctermfg=28 ctermbg=68
  ...
  hi PreProc ctermfg=9 ctermbg=83
  hi Question ctermfg=28 ctermbg=83
  hi Repeat ctermfg=72
  hi SignColumn ctermfg=76 ctermbg=81
  hi Special ctermfg=39 ctermbg=84
  hi SpecialChar ctermfg=79 ctermbg=83
  hi SpecialComment ctermfg=75 ctermbg=83
  hi SpecialKey ctermfg=9 ctermbg=83
  ...
  hi WarningMsg ctermfg=39 ctermbg=68
...
elseif &t_Co == 16
  ...
  hi DiffDelete ctermbg=3
  hi Directory ctermfg=11 ctermbg=8
  ...
  hi Question ctermfg=2 ctermbg=8
  hi Repeat ctermfg=7
  ...
  hi SpecialKey ctermfg=9 ctermbg=8
  hi Statement ctermfg=14
